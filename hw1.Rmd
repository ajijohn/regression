...
#data:  mri[!is.na(mri$packyrs) & (mri$packyrs == 0) & (mri$death ==  and mri[!is.na(mri$packyrs) & (mri$packyrs == 0) & (mri$death ==     0), ] and     1), ]
#t = 0.14825, df = 2011.5, p-value = 0.8822
...
Answer. We do a t-test, For

*Group 0 - No smokers, 0 (thru the study) - 272, 1(not thru the study) - 49

As p-value is 0.8 (using critical value of 0.05), We fail to reject the null hypothesis that expected number of individuals based on being non-smoker would be the same.
